...
// Specific visuals map based on your request
const ESSENTIAL_IMAGES: Record<string, string> = {
  "Vodka": "https://www.thecocktaildb.com/images/ingredients/Absolut%20Vodka-Small.png",
  ...
  "White Rum": "https://www.thecocktaildb.com/images/ingredients/White%20Rum-Small.png",
  "Bourbon": "https://www.thecocktaildb.com/images/ingredients/Bourbon-Small.png",
  "Whiskey": "https://www.thecocktaildb.com/images/ingredients/Blended%20whiskey-Small.png",
  "Rum": "https://www.thecocktaildb.com/images/ingredients/Dark%20rum-Small.png",
  "Mezcal": "https://www.thecocktaildb.com/images/ingredients/Mezcal-Small.png",
            ...
            <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                    {essentials.map(ing => {
                        ...
                        const imageUrl = ESSENTIAL_IMAGES[ing.name];
                            ...
                            >
                                {imageUrl ? (
                                    <img 
                                        src={imageUrl} 
                                        alt={ing.name}
                                        className="h-10 w-auto mb-2 object-contain filter drop-shadow-md transition-transform group-hover:scale-110" 
                                    />
                                ) : (
